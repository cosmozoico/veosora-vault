...
import bgJpg from "@/assets/bgjpg.webp";
      ...
      <section className="relative overflow-x-clip">
        <div className="relative min-h-[600px] md:min-h-[700px] flex items-center">
          ...
          <div className="absolute top-0 right-0 w-[120%] md:w-2/3 h-full">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-background via-transparent via-10% to-transparent"></div>
          </div>
            ...
            <div className="max-w-[200px]">
              ...
              <div className="flex flex-col gap-3 mb-4">
                <InteractiveHoverButton 
                  ...
                  onClick={() => window.location.href = 'https://pay.kirvano.com/b8cbe4db-56ad-4667-9229-3c13e61420a0'}
                />
              </div>
            </div>
          </div>
            ...
            <div className="bg-[#0F1114] rounded-2xl p-8 shadow-2xl border border-gray-800 text-white">
              <div className="text-center mb-6">
                ...
                <div className="flex items-baseline justify-center gap-2">
                  <span className="text-purple-400 text-sm">12x de</span>
                  <span className="text-5xl md:text-6xl font-bold text-white">R$ 12,89</span>
                </div>
                <div className="text-gray-400 text-sm mt-2">ou R$ 125,85 a vista</div>
              </div>
